...
class ChatController: UICollectionViewController, UICollectionViewDelegateFlowLayout {
    ...
    lazy var containerView: UIView = {
        ...
        messageTextField.anchor(top: containerView.topAnchor, left: containerView.leftAnchor, bottom: containerView.bottomAnchor, right: sendButton.leftAnchor , paddingTop: 0, paddingLeft: 12, paddingBottom: 10, paddingRight: 8, width: 0, height: 0)
...
//            } else if let imageWidth = message.imageWidth?.floatValue, let imageHeight =
//                message.imageHeight?.floatValue {
//                
